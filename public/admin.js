...
async function openCase(id){
  ...
  const deleteSection=currentUser?.role==='admin'?`<section class="drawer-section complaint-danger-zone"><h3>ลบเรื่องร้องเรียน</h3><p>การลบจะนำเรื่อง ประวัติ และรูปภาพทั้งหมดออกอย่างถาวร</p><button id="deleteComplaintButton" type="button" class="delete-complaint-button">ลบเรื่องร้องเรียน</button></section>`:'';
  ...
  if(currentUser?.role==='admin')$('#deleteComplaintButton').onclick=()=>openDeleteComplaintConfirmation(c);
